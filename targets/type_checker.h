// $Id: type_checker.h,v 1.2 2018/05/10 17:50:35 ist424870 Exp $ -*- c++ -*-
...
namespace gr8 {
  ...
  protected:
    ...
    void processUnaryExpressionNumbers(cdk::unary_expression_node * const node, int lvl);
    void processBinaryExpression(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpressionNumbers(cdk::binary_expression_node * const node, int lvl);
